...
export function Carusel({ type = "offers" }: CarouselProps) {
    ...
    const handleBannerClick = () => navigate("/all-products")
    ...
    const bannerOffers = [
        ...
        { id: 3, title: "Oferta Especial", subtitle: "Descuentos hasta el", price: "40% OFF", oldPrice: "", sku: "", image: "", bg: "linear-gradient(180deg, #F4DCC9 0%, #F0D9C0 100%)", badge: "", description: "En artículos seleccionados de papelería y útiles escolares.", icon: "🎁" },
        { id: 4, title: "Cuadernos Moleskine", subtitle: "Cuadernos Premium de Alta Calidad", price: "A: $299.99", oldPrice: "De: $450.00", sku: "SKU: 125680", image: "", bg: "linear-gradient(180deg, #E8C9B8 0%, #DEC0AB 100%)", badge: "STOCK LIMITADO", description: "Vigencia del 1 al 31 de enero de 2026.", icon: "📓" },
        { id: 5, title: "Set de Marcadores Artísticos", subtitle: "72 Colores Premium", price: "A: $899.99", oldPrice: "De: $1,299.00", sku: "SKU: 456789", image: "", bg: "linear-gradient(180deg, #F0D9C0 0%, #E8D0B5 100%)", badge: "HASTA -30%", description: "Para diseño y arte profesional.", icon: "🖍️" },
        { id: 6, title: "Papel Bond Premium", subtitle: "Resma de 500 hojas", price: "A: $79.99", oldPrice: "De: $120.00", sku: "SKU: 987654", image: "", bg: "linear-gradient(180deg, #B8E6D5 0%, #F0D9C0 100%)", badge: "OFERTA", description: "Para impresoras e impresoras láser.", icon: "📄" },
        { id: 7, title: "Estuche Completo para Artistas", subtitle: "Todo lo que necesitas en un set", price: "A: $1,299.99", oldPrice: "De: $1,899.00", sku: "SKU: 543210", image: "", bg: "linear-gradient(180deg, #A8E6E1 0%, #F4DCC9 100%)", badge: "PROMOCIÓN", description: "Incluye lápices, marcadores y más.", icon: "🎨" },
    ]
